    ...
    if(ae.getSource() == deposit){
        ...
        Date date = new Date();
         ...
         String number = amount.getText().trim();
          ...
          if (number.equals("")) {
            warningLabel.setText("Please enter the amount to deposit.");
            ...
            conn conn = new conn();
            String qurrey = "insert into bank1 values('"+pinnumber+"','"+date+"','Deposit', '"+number+"')";
            conn.s.executeUpdate(qurrey);
